import time
from selenium import webdriver                        # selenium = 函式庫 
from selenium.webdriver.common.by import By
from selenium.webdriver.support.select import Select  #下拉式選單使用

"""
selenium = 函式庫
可以模擬出使用者在瀏覽器的所有操作行為 ( 點擊按鈕、輸入帳號密碼、捲動捲軸...等 )
"""
...
driver.get("https://www.selenium.dev/selenium/web/web-form.html")   #要爬的網站
...
number_dropdown = driver.find_element(
    By.XPATH, "//select[@class='form-select' and @name='my-select']")   # XPATH 格式
