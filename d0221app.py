...
def callback():
    ...
    signature = request.headers['X-Line-Signature']     #簽名
    ...
    try:
        ...
        app.logger.info(
            "Invalid signature. Please check your channel access token/channel secret.")    #如果錯了，會請你重新檢查
        abort(400)
